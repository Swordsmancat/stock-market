...
## Session 1: Market depth fallback contract

**Date**: 2026-07-04
**Task**: Market depth fallback contract
**Branch**: `master`

### Summary

Implemented degraded-safe market depth contracts across backend API, instrument detail proxy, and detail UI with tests.
