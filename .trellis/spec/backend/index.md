...
| [InStock-Inspired Strategy Screening Contract](./instock-strategy-screening-contract.md) | Research-only strategy screening API, InStock attribution boundary, and no-trading rules | Filled |
