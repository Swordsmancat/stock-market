...
| [Read-Only Crawler Monitor Contract](./crawler-monitor-contract.md) | Curated TaskRun selectors, non-mutating health projection, bounded evidence, localization, and refresh behavior | Filled |
