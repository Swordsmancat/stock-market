...
- Scope: `packages/services/news_provider_registry.py`, `packages/services/news_search.py`, `packages/services/platform_settings.py`, `apps/api/routers/news.py`, `apps/api/routers/settings.py`, settings UI consumers, and focused tests.
