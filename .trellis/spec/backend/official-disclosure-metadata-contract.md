...
- Provider tests inject fake dataframes and assert argument mapping, timezone normalization, host/path/ID validation, schema errors, bounded ranges, row rejection, and sanitized provider failures.
